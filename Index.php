...
<body>
    ...
    <section class="hero" id="hero">
        <div class="hero-overlay">
            ...
            <div id="revendedor-view" class="hero-action">
                <button id="revendedorBtn" class="button-revendedor">
                    SOY REVENDEDOR.!
            ...
            <!-- cartel para cargar codigo o pedir -->
            <div id="modalRevendedor" class="modal-container">
    
                <div id="cardLogin" class="modal-card">
                    <button class="modal-close-x closeModal">&times;</button>
                    <h3>Acceso Revendedores</h3>
                    <p>Ingrese su código para ver precios especiales</p>
                    <div class="modal-body">
                        <input type="text" id="inputCodigoModal" placeholder="Ej: REV-123" class="modal-input">
                        <button id="btnValidarModal" class="modal-btn-apply">Aplicar Código</button>
                        <a href="javascript:void(0)" id="linkMostrarSolicitud" class="link-pedir-codigo">Pedir código</a>
                    </div>
                    <div id="mensajeModal" class="modal-message"></div>
                </div>

                <div id="cardSolicitud" class="modal-card" style="display: none;">
                    <button class="modal-close-x closeModal">&times;</button>
                    <h3>Solicitar código de revendedor con descuentos</h3>
                    <p>Complete sus datos para recibir su código por WhatsApp</p>
                    
                    <div class="modal-form">
                        <input type="text" id="reqNombre" placeholder="Nombre" class="modal-input">
                        <input type="text" id="reqApellido" placeholder="Apellido" class="modal-input">
                        <input type="text" id="reqDireccion" placeholder="Dirección del local" class="modal-input">
                        
                        <div class="radio-group">
                            <label>Tipo de compra:</label>
                            <div class="radio-option">
                                <input type="radio" name="tipoCompra" value="Compra mínima" id="minima" checked>
                                <label for="minima">Compra mínima</label>
                            </div>
                            <div class="radio-option">
                                <input type="radio" name="tipoCompra" value="Compra en cantidad" id="cantidad">
                                <label for="cantidad">Compra en cantidad</label>
                            </div>
                        </div>

                        <button id="btnEnviarWhatsapp" class="modal-btn-whatsapp">
                            Solicitar precios de revendedor
                        </button>
                        <a href="javascript:void(0)" id="linkVolverLogin" style="display:block; margin-top:10px; font-size:12px; color:#764ba2;">Volver atrás</a>
                    </div>
                </div>
            </div>
    ...
    <main class="main" id="products">
        <div class="container">
            ...
            <div class="search-box">
                ...
                <div id="searchSuggestions" class="search-results-wrapper" style="display: none;">
    ...
    <div id="catalogContainer" style="display: none !important; text-align: center; margin: 0 auto 25px auto; max-width: 400px;">
            <button id="btnDescargarCatalogo" class="btn-catalog">
            ...
            <div class="buttons-container">
                ...
                <!-- Botón Rotisería -->
                <button class="category-button rotiseria-button" data-category="Rotiseria">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Botón Panadería -->
                <button class="category-button panaderia-button" data-category="Panaderia">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Botón Carnicería -->
                <button class="category-button carniceria-button" data-category="Carniceria">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Botón Verdulería -->
                <button class="category-button verduleria-button" data-category="Verduleria">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button class="category-button restaurante-button" data-category="Resto-roti-bar">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button class="category-button minimercado-button" data-category="Supermercado-Mini-Servicio">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Botón Boutique -->
                <button class="category-button boutique-button" data-category="Botique">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button class="category-button estacion-button" data-category="Estacion-Servicio">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button class="category-button clinica-button" data-category="Clinica-Consultorio">
                    <div class="button-content">
                        <div class="icon-container">
                            <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="button-text">Clínica y Consultoria</span>
                    </div>
                </button>
